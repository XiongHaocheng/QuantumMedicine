<template>
  <div class="doseprediction-page">
    <DosePredictionQuantumLoading v-if="isProcessing" />
    <!-- 新增的两个横排卡片 -->
    <div class="card-section">
      <div class="card-container">
        ...
        <div class="simple-card">
          ...
          <hr class="card-line" />
          <h4>当前工作流</h4>
          <div class="pet-content">剂量预测</div>
          <hr class="card-line" />
          <div class="input-section">
            ...
            <div class="upload-prompt">
              ...
              <div class="tooltip-icon">
                ...
                <span class="tooltip-text">上传病人 CT 数据（ct.csv）以及 ROI 信息（可选多个 CSV）</span>
              </div>
            </div>
            <!-- 文件上传区域 -->
            <div class="upload-box" @click="triggerFileInput" :class="{ 'error': fileError }">
              <input type="file" ref="fileInput" @change="handleFileChange" accept=".zip" class="file-input">
        ...
        <div class="simple-card">
          ...
          <div class="metric-container">
            ...
            <div class="metric-row">
              <p class="metric-label">DoseScore[Gy]</p>
              <div class="pet-result">{{ resultData ? resultData.DoseScore : '--' }}</div>
            </div>

            <div class="metric-row">
              <p class="metric-label">DVH score[Gy]</p>
              <div class="pet-result">{{ resultData ? resultData.DVHScore : '--' }}</div>
            </div>
...
const PredictImage = new URL('../assets/Prediction/predict.png', import.meta.url).href;
const GroundTruthImage = new URL('../assets/Prediction/groundtruth.png', import.meta.url).href;
import DosePredictionQuantumLoading from "../components/doseprediction/DosePredictionQuantumLoading.vue"; // 引入组件
